---
title: "Sensitivity Analysis - 5km"
...
```{r}
built_area <- read_csv(here("data", "sensitivity_analysis", "5km", "pressure", "built_area_5km.csv")) %>% 
...
human_mod <- read_csv(here("data", "sensitivity_analysis", "5km", "pressure", "human_mod_5km.csv")) %>% 
  ...
  clean_names() %>% 
  filter(id != 331 & id != 511)
pop <- read_csv(here("data", "sensitivity_analysis", "5km", "pressure", "pop_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  #filter(region == "Sul") %>% # for Southern region
  ...
  clean_names() %>% 
  filter(id != 331 & id != 511)
ports <- read_csv(here("data", "sensitivity_analysis", "5km", "pressure", "ports_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  clean_names() %>% 
  filter(id != 331 & id != 511)
roads <- read_csv(here("data", "sensitivity_analysis", "5km", "pressure", "roads_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
...
```{r}
write_csv(pressure_normalized, file = "nne_normalized_pressure_5km.csv")
```
...
```{r}
marine_richness <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "marine_rich_5km.csv")) %>%
  filter(id >= 93 & id <= 194 | id >= 445 & id <= 510 | id >= 537 & id <=548) %>% # for northern and northeastern regions
  # filter(id >= 9 & id <= 92 | id >= 329 & id <= 444 | id >= 519 & id <= 536) %>% # for Southeastern region
  #filter(id >= 0 & id <= 8 | id >= 195 & id <= 328 | id >= 512 & id <= 518) %>% # for Southern region
  select(id, MEAN) %>% 
  clean_names() %>% 
  filter(id != 331 & id != 511)
terr_richness <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "terr_rich_5km.csv")) %>% 
  filter(id >= 93 & id <= 194 | id >= 445 & id <= 510 | id >= 537 & id <=548) %>% # for northern and northeastern regions
  # filter(id >= 9 & id <= 92 | id >= 329 & id <= 444 | id >= 519 & id <= 536) %>% # for Southeastern region
  # filter(id >= 0 & id <= 8 | id >= 195 & id <= 328 | id >= 512 & id <= 518) %>% # for Southern region
  select(id, MEAN) %>% 
  clean_names() %>% 
  filter(id != 331 & id != 511)
coral <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "coral_reef_5km.csv")) %>%
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
mangrove <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "mangrove_5km.csv")) %>% 
  filter(id >= 93 & id <= 194 | id >= 445 & id <= 510 | id >= 537 & id <=548) %>% # for northern and northeastern regions
  # filter(id >= 9 & id <= 92 | id >= 329 & id <= 444 | id >= 519 & id <= 536) %>% # for Southeastern region
  # filter(id >= 0 & id <= 8 | id >= 195 & id <= 328 | id >= 512 & id <= 518) %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
seagrass <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "seagrass_5km.csv")) %>% 
  filter(id >= 93 & id <= 194 | id >= 445 & id <= 510 | id >= 537 & id <=548) %>% # for northern and northeastern regions
  # filter(id >= 9 & id <= 92 | id >= 329 & id <= 444 | id >= 519 & id <= 536) %>% # for Southeastern region
  # filter(id >= 0 & id <= 8 | id >= 195 & id <= 328 | id >= 512 & id <= 518) %>% # for Southern region
  select(id, region, Join_Count) %>% 
  clean_names() %>% 
  filter(id != 331 & id != 511)
tree_cover <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "tree_cover_5km.csv")) %>%
  filter(id >= 93 & id <= 194 | id >= 445 & id <= 510 | id >= 537 & id <=548) %>% # for northern and northeastern regions
  # filter(id >= 9 & id <= 92 | id >= 329 & id <= 444 | id >= 519 & id <= 536) %>% # for Southeastern region
  # filter(id >= 0 & id <= 8 | id >= 195 & id <= 328 | id >= 512 & id <= 518) %>% # for Southern region
  select(id, MEAN) %>% 
  clean_names() %>% 
  filter(id != 331 & id != 511)
terr_pa_high <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "terr_pa_high_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
terr_pa_ver_high <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "terr_pa_v_high_5km.csv")) %>%
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
terr_pa_ext_high <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "terr_pa_ext_high_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
ocean_pa <- read_csv(here("data", "sensitivity_analysis", "5km", "biodiversity", "oceanic_pa_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
...
```{r}
write_csv(biodiversity_normalized, file = "nne_normalized_biodiversity_5km.csv")
```
...
```{r}
# read in data
surf_indicators <- read_csv(here("data", "sensitivity_analysis", "5km", "surf", "surf_indicators_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  filter(id != 331 & id != 511) %>% 
...
```{r}
write_csv(surf_normalized, file = "nne_normalized_surf_5km.csv")
```

## Social Subindex

```{r}
employment <- read_csv(here("data", "sensitivity_analysis", "5km", "social", "employment_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
hotels <- read_csv(here("data", "sensitivity_analysis", "5km", "social", "hotels_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  select(id, region, Join_Count) %>% 
  clean_names() %>% 
  filter(id != 331 & id != 511)
airports <- read_csv(here("data", "sensitivity_analysis", "5km", "social", "airports_5km.csv")) %>%
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  select(id, region, Join_Count) %>% 
...
```{r}
write_csv(social_normalized, file = "nne_normalized_social_5km.csv")
```
...
climate <- read_csv(here("data", "climate", "climate.csv")) %>% 
  ...
  clean_names() %>% 
  filter(id != 331 & id != 511) %>% 
  select(nm_regiao, id, sum_5km, hab_5km)
```

# Mangrove Carbon

```{r}
max_carbon <- round(max(climate$sum_5km), 10)
min_carbon <- round(min(climate$sum_5km), 10)

climate <- climate %>% 
  mutate(normalized_carbon = round((sum_5km - min_carbon) / (max_carbon - min_carbon), 10))
```

# Coastal Protection

```{r}
max_cp <- round(max(climate$hab_5km), 10)
min_cp <- round(min(climate$hab_5km), 10)

climate <- climate %>% 
  mutate(normalized_cp = round((hab_5km - min_cp) / 
                                 (max_cp - min_cp), 10))
```
...
```{r}
write_csv(climate_normalized, file = "nne_normalized_climate_5km.csv")
```

# Response Index

```{r}
heritage <- read_csv(here("data", "sensitivity_analysis", "5km", "response", "world_heri_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
atl_for_priority <- read_csv(here("data", "sensitivity_analysis", "5km", "response", "atl_forest_5km.csv")) %>%
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
guarda <- read_csv(here("data", "sensitivity_analysis", "5km", "response", "wsr_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
prot_areas <- read_csv(here("data", "sensitivity_analysis", "5km", "response", "protected_5km.csv")) %>%
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  ...
  filter(id != 331 & id != 511)
bandeira <- read_csv(here("data", "sensitivity_analysis", "5km", "response", "bandeira_5km.csv")) %>%
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
  select(id, region, Join_Count) %>% 
  clean_names() %>% 
  filter(id != 331 & id != 511)
ramsar <- read_csv(here("data", "sensitivity_analysis", "5km", "response", "ramsar_5km.csv")) %>% 
  filter(region %in% c("Norte", "Nordeste")) %>% # for Northern and Northeastern region
  # filter(region == "Sudeste") %>%  # for Southeastern region
  # filter(region == "Sul") %>% # for Southern region
...
```{r}
write_csv(response_normalized, file = "nne_normalized_response_5km.csv")
```
...
```{r}
write_csv(sci_normalized, file = "nne_sci_wo_climate_5km.csv")
```
...
```{r}
write_csv(sci_normalized_climate, file = "nne_sci_w_climate_5km.csv")
```

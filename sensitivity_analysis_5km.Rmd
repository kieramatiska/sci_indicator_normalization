...
```{r}
write_csv(pressure_normalized, file = "s_normalized_pressure_5km.csv")
```
...
```{r}
write_csv(biodiversity_normalized, file = "s_normalized_biodiversity_5km.csv")
```
...
```{r}
write_csv(surf_normalized, file = "s_normalized_surf_5km.csv")
```
...
```{r}
write_csv(social_normalized, file = "s_normalized_social_5km.csv")
```
...
```{r}
write_csv(climate_normalized, file = "s_normalized_climate_5km.csv")
```
...
```{r}
write_csv(sci_normalized, file = "s_sci_wo_climate_5km.csv")
```
...
```{r}
write_csv(sci_normalized_climate, file = "s_sci_w_climate_5km.csv")
```

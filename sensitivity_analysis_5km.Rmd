...
```{r}
write_csv(pressure_normalized, file = "se_normalized_pressure_5km.csv")
```
...
```{r}
write_csv(biodiversity_normalized, file = "se_normalized_biodiversity_5km.csv")
```
...
```{r}
write_csv(surf_normalized, file = "se_normalized_surf_5km.csv")
```
...
```{r}
write_csv(social_normalized, file = "se_normalized_social_5km.csv")
```
...
```{r}
write_csv(climate_normalized, file = "se_normalized_climate_5km.csv")
```
...
```{r}
write_csv(sci_normalized, file = "se_sci_wo_climate_5km.csv")
```
...
```{r}
write_csv(sci_normalized_climate, file = "se_sci_w_climate_5km.csv")
```

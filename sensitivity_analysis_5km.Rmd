...
```{r}
write_csv(pressure_normalized, file = "normalized_pressure_5km.csv")
```
...
```{r}
write_csv(biodiversity_normalized, file = "normalized_biodiversity_5km.csv")
```
...
```{r}
write_csv(surf_normalized, file = "normalized_surf_5km.csv")
```
...
```{r}
write_csv(social_normalized, file = "normalized_social_5km.csv")
```
...
```{r}
write_csv(climate_normalized, file = "normalized_climate_5km.csv")
```
...
```{r}
write_csv(response_normalized, file = "normalized_response_5km.csv")
```
...
```{r}
write_csv(sci_normalized, file = "sci_wo_climate_5km.csv")
```
...
```{r}
write_csv(sci_normalized_climate, file = "sci_w_climate_5km.csv")
```

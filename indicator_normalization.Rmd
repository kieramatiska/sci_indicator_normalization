...
```{r}
marine_eco_weighted <- left_join(coral, seagrass,
                                 by= "objectid") %>% 
  select(objectid, name.x, surf_spot.x, 
         sum_area_s, coral_reef, normalized_coral_reef, 
         join_count, normalized_seagrass)

marine_eco_weighted <- left_join(marine_eco_weighted, mangrove,
                                 by = "objectid")
